...
export default function SubscriptionCard({
    ...
    return (
        <>
            {/* Basic */}
            {!isPremium && (
                <div className="flex flex-col gap-[30px] box-shadow-white py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content]">
            ...
            {/* For Greatest */}
            {isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] box-shadow-black px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                    {/* Ornament Icon */}
                    <div className="bg-mtcolor rounded-full p-[13px] max-w-max">
